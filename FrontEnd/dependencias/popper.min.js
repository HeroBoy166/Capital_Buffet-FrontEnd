...
function m(e) {
    var t = e && e.offsetParent
      , o = t && t.nodeName;
    return o && 'BODY' !== o && 'HTML' !== o ? -1 !== ['TD', 'TABLE'].indexOf(t.nodeName) && 'static' === a(t, 'position') ? m(t) : t : e ? e.ownerDocument.documentElement : document.documentElement
}
function h(e) {
    var t = e.nodeName;
...
var y, E = function() {
    return void 0 == y && (y = -1 !== navigator.appVersion.indexOf('MSIE 10')),
    y
};
function v(e, t, o, i) {
    return Math.max(t['offset' + e], t['scroll' + e], o['client' + e], o['offset' + e], o['scroll' + e], E() ? o['offset' + e] + i['margin' + ('Height' === e ? 'Top' : 'Left')] + i['margin' + ('Height' === e ? 'Bottom' : 'Right')] : 0)
}
function O() {
    var e = document.body
...
function C(e, t) {
    ...
    return (o ? t.contains(p) : t === p && 'BODY' !== p.nodeName) && (m = b(m, t)),
    m
}
function k(e) {
    var t = Math.max
...
function W(e) {
    var t = e.nodeName;
    return 'BODY' === t || 'HTML' === t ? !1 : !('fixed' !== a(e, 'position')) || W(l(e))
}
function P(e, t, o, i) {
    var n = {
        top: 0,
    ...
    if ('viewport' === i)
        ...
        var p;
        'scrollParent' === i ? (p = f(l(t)),
        'BODY' === p.nodeName && (p = e.ownerDocument.documentElement)) : 'window' === i ? p = e.ownerDocument.documentElement : p = i;
        var s = C(p, r);
        if ('HTML' === p.nodeName && !W(r)) {
            var d = O()
              , a = d.height
              , m = d.width;
...
function F(e, t, o) {
    ...
    return i.forEach(function(e) {
        ...
        e.enabled && d(o) && (t.offsets.popper = D(t.offsets.popper),
...
function K() {
    if (!this.state.isDestroyed) {
        ...
        e.placement = H(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding),
...
function V() {
    ...
    j(this.modifiers, 'applyStyle') && (this.popper.removeAttribute('x-placement'),
...
function G(e, t, o, i) {
    ...
    n || G(f(r.parentNode), t, o, i),
    i.push(r)
}
function _(e, t, o, i) {
    o.updateBound = i,
    z(e).addEventListener('resize', o.updateBound, {
        passive: !0
    });
    var n = f(e);
    return G(n, 'scroll', o.updateBound, o.scrollParents),
    o.scrollElement = n,
    o.eventsEnabled = !0,
    o
}
...
function $(e, t) {
    Object.keys(t).forEach(function(o) {
        var i = '';
        -1 !== ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(o) && Z(t[o]) && (i = 'px'),
        e.style[o] = t[o] + i
    })
}
function ee(e, t) {
...
function ie(e, t) {
    ...
    var s, d, a = void 0 === p ? t.gpuAcceleration : p, l = m(e.instance.popper), f = N(l), h = {
        position: r.position
    }, c = {
        left: o(r.left),
        top: o(r.top),
        bottom: o(r.bottom),
        right: o(r.right)
    }, g = 'bottom' === i ? 'top' : 'bottom', u = 'right' === n ? 'left' : 'right', b = q('transform');
    if (d = 'bottom' == g ? -f.height + c.bottom : c.top,
    ...
    return e.attributes = T({}, E, e.attributes),
...
function re(e, t) {
    var o;
    if (!ne(e.instance.modifiers, 'arrow', 'keepTogether'))
        return e;
    var i = t.element;
    if ('string' == typeof i) {
    ...
    return E = Math.max(Math.min(p[l] - g, E), 0),
    e.arrowElement = i,
    e.offsets.arrow = (o = {},
    S(o, m, Math.round(E)),
    S(o, h, ''),
...
function fe(e, t) {
    ...
    return p.forEach(function(s, d) {
        ...
        y && (r = pe(r)),
        e.placement = i + (r ? '-' + r : ''),
        e.offsets.popper = T({}, e.offsets.popper, R(e.instance.popper, e.offsets.reference, e.placement)),
...
function he(e, t, o, i) {
    ...
    if ('vh' === s || 'vw' === s) {
        var l;
        return l = 'vh' === s ? n(document.documentElement.clientHeight, window.innerHeight || 0) : n(document.documentElement.clientWidth, window.innerWidth || 0),
        l / 100 * p
    }
    return p
}
...
function ue(e, t) {
    ...
    var n = t.priority
      ...
      , p = {
        primary: function(e) {
            var o = r[e];
            return r[e] < i[e] && !t.escapeWithReference && (o = Math.max(r[e], i[e])),
            S({}, e, o)
        },
        secondary: function(e) {
            var o = 'right' === e ? 'left' : 'top'
              , n = r[o];
            return r[e] > i[e] && !t.escapeWithReference && (n = Math.min(r[o], i[e] - ('right' === e ? r.width : r.height))),
            S({}, o, n)
        }
    };
...
function we(e) {
    if (!ne(e.instance.modifiers, 'hide', 'preventOverflow'))
        return e;
  ...
  , Oe = function() {
    function e(t, o) {
        ...
        Object.keys(T({}, e.Defaults.modifiers, n.modifiers)).forEach(function(t) {
            i.options.modifiers[t] = T({}, e.Defaults.modifiers[t] || {}, n.modifiers ? n.modifiers[t] : {})
        }),
        ...
        this.modifiers.forEach(function(e) {
            e.enabled && d(e.onLoad) && e.onLoad(i.reference, i.popper, i.options, e, i.state)
        }),
        this.update();
